...
def initialize_database():
    ...
    if not os.path.exists(DB_FILE):
        ...
        cursor = conn.cursor()
        cursor.execute('''CREATE TABLE IF NOT EXISTS albums (id INTEGER PRIMARY KEY, albumName TEXT, artistName TEXT, year INTEGER, genre TEXT, decription TEXT, albumCoverPath BLOB)''')
